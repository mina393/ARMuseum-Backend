        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UDateOfBirth = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UPhone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UCountry = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UImageName = table.Column<string>(type: "nvarchar(max)", nullable: true),
