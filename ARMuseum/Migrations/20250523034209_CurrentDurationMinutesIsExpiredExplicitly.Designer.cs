...
namespace ARMuseum.Migrations
{
    ...
    [Migration("20250523034209_CurrentDurationMinutesIsExpiredExplicitly")]
    partial class CurrentDurationMinutesIsExpiredExplicitly
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ARMuseum.Data.Models.TbBuyAticket", b =>
                {
                    ...
                    b.Property<int>("CurrentDurationMinutes")
                        .HasColumnType("int")
                        .HasColumnName("Current_Duration_Minutes");

                    b.Property<bool>("IsExpiredExplicitly")
                        .HasColumnType("bit")
                        .HasColumnName("Is_Expired_Explicitly");
